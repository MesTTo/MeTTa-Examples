...
The merged corpus contains 324 examples that run in the shell suite.
...
143 of the 350 programs here derive from the MeTTa examples of the project at
...
207 examples were written for this repository.
