...
The merged corpus contains 346 examples that run in the shell suite.
...
143 of the 372 programs here derive from the MeTTa examples of the project at
...
229 examples were written for this repository.
