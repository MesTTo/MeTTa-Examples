...
The merged corpus contains 327 examples that run in the shell suite.
...
143 of the 353 programs here derive from the MeTTa examples of the project at
...
210 examples were written for this repository.
