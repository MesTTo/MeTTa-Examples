...
The merged corpus contains 334 examples that run in the shell suite.
...
143 of the 360 programs here derive from the MeTTa examples of the project at
...
217 examples were written for this repository.
