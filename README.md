...
The merged corpus contains 347 examples that run in the shell suite.
...
143 of the 373 programs here derive from the MeTTa examples of the project at
...
230 examples were written for this repository.
