...
The merged corpus contains 320 examples that run in the shell suite.
...
143 of the 346 programs here derive from the MeTTa examples of the project at
...
203 examples were written for this repository.
