...
The merged corpus contains 333 examples that run in the shell suite.
...
143 of the 359 programs here derive from the MeTTa examples of the project at
...
216 examples were written for this repository.
