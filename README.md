...
The merged corpus contains 332 examples that run in the shell suite.
...
143 of the 358 programs here derive from the MeTTa examples of the project at
...
215 examples were written for this repository.
