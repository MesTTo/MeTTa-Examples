...
The merged corpus contains 343 examples that run in the shell suite.
...
143 of the 369 programs here derive from the MeTTa examples of the project at
...
226 examples were written for this repository.
