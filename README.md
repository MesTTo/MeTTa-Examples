...
The merged corpus contains 254 examples that run in the shell suite.
...
143 of the 273 programs here derive from the MeTTa examples of the project at
...
130 examples were written for this repository.
