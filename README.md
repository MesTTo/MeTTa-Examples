...
The merged corpus contains 326 examples that run in the shell suite.
...
143 of the 352 programs here derive from the MeTTa examples of the project at
...
209 examples were written for this repository.
