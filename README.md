...
The merged corpus contains 316 examples that run in the shell suite.
...
143 of the 342 programs here derive from the MeTTa examples of the project at
...
199 examples were written for this repository.
