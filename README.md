...
The merged corpus contains 241 examples that run in the shell suite.
...
143 of the 260 programs here derive from the MeTTa examples of the project at
...
117 examples were written for this repository.
