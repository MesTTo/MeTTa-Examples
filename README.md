...
The merged corpus contains 313 examples that run in the shell suite.
...
143 of the 336 programs here derive from the MeTTa examples of the project at
...
193 examples were written for this repository.
