...
The merged corpus contains 338 examples that run in the shell suite.
...
143 of the 364 programs here derive from the MeTTa examples of the project at
...
221 examples were written for this repository.
