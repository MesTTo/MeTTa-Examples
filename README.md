...
The merged corpus contains 321 examples that run in the shell suite.
...
143 of the 347 programs here derive from the MeTTa examples of the project at
...
204 examples were written for this repository.
