...
The merged corpus contains 247 examples that run in the shell suite.
The merged corpus contains 245 examples that run in the shell suite.
...
143 of the 262 programs here derive from the MeTTa examples of the project at
143 of the 266 programs here derive from the MeTTa examples of the project at
...
119 examples were written for this repository.
123 examples were written for this repository.
