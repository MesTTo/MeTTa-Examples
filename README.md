...
The merged corpus contains 329 examples that run in the shell suite.
...
143 of the 355 programs here derive from the MeTTa examples of the project at
...
212 examples were written for this repository.
