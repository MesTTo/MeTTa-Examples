...
The merged corpus contains 266 examples that run in the shell suite.
...
143 of the 285 programs here derive from the MeTTa examples of the project at
...
142 examples were written for this repository.
