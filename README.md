...
The merged corpus contains 345 examples that run in the shell suite.
...
143 of the 371 programs here derive from the MeTTa examples of the project at
...
228 examples were written for this repository.
