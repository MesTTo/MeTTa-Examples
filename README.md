...
The merged corpus contains 257 examples that run in the shell suite.
...
143 of the 276 programs here derive from the MeTTa examples of the project at
...
133 examples were written for this repository.
