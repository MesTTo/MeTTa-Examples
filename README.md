...
The merged corpus contains 325 examples that run in the shell suite.
...
143 of the 351 programs here derive from the MeTTa examples of the project at
...
208 examples were written for this repository.
