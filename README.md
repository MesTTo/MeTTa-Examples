...
The merged corpus contains 248 examples that run in the shell suite.
...
143 of the 267 programs here derive from the MeTTa examples of the project at
...
124 examples were written for this repository.
