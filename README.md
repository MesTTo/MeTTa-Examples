...
The merged corpus contains 249 examples that run in the shell suite.
...
143 of the 268 programs here derive from the MeTTa examples of the project at
...
125 examples were written for this repository.
