...
The merged corpus contains 342 examples that run in the shell suite.
...
143 of the 368 programs here derive from the MeTTa examples of the project at
...
225 examples were written for this repository.
