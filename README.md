...
The merged corpus contains 340 examples that run in the shell suite.
...
143 of the 366 programs here derive from the MeTTa examples of the project at
...
223 examples were written for this repository.
