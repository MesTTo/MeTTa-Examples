...
The merged corpus contains 253 examples that run in the shell suite.
...
143 of the 272 programs here derive from the MeTTa examples of the project at
...
129 examples were written for this repository.
