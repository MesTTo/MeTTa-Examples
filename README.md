...
The merged corpus contains 331 examples that run in the shell suite.
...
143 of the 357 programs here derive from the MeTTa examples of the project at
...
214 examples were written for this repository.
