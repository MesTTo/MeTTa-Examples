...
The merged corpus contains 328 examples that run in the shell suite.
...
143 of the 354 programs here derive from the MeTTa examples of the project at
...
211 examples were written for this repository.
