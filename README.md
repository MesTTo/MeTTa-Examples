...
The merged corpus contains 251 examples that run in the shell suite.
...
143 of the 270 programs here derive from the MeTTa examples of the project at
...
127 examples were written for this repository.
