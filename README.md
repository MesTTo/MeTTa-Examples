...
The merged corpus contains 312 examples that run in the shell suite.
...
143 of the 335 programs here derive from the MeTTa examples of the project at
...
192 examples were written for this repository.
