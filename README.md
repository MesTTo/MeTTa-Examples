...
The merged corpus contains 341 examples that run in the shell suite.
...
143 of the 367 programs here derive from the MeTTa examples of the project at
...
224 examples were written for this repository.
