...
The merged corpus contains 307 examples that run in the shell suite.
...
143 of the 330 programs here derive from the MeTTa examples of the project at
...
187 examples were written for this repository.
