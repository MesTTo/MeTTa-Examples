...
The merged corpus contains 344 examples that run in the shell suite.
...
143 of the 370 programs here derive from the MeTTa examples of the project at
...
227 examples were written for this repository.
