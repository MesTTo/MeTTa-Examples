...
The merged corpus contains 337 examples that run in the shell suite.
...
143 of the 363 programs here derive from the MeTTa examples of the project at
...
220 examples were written for this repository.
