...
The merged corpus contains 336 examples that run in the shell suite.
...
143 of the 362 programs here derive from the MeTTa examples of the project at
...
219 examples were written for this repository.
