...
The merged corpus contains 250 examples that run in the shell suite.
...
143 of the 269 programs here derive from the MeTTa examples of the project at
...
126 examples were written for this repository.
