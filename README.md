...
The merged corpus contains 335 examples that run in the shell suite.
...
143 of the 361 programs here derive from the MeTTa examples of the project at
...
218 examples were written for this repository.
