...
The merged corpus contains 252 examples that run in the shell suite.
...
143 of the 271 programs here derive from the MeTTa examples of the project at
...
128 examples were written for this repository.
