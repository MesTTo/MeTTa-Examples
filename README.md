...
The merged corpus contains 258 examples that run in the shell suite.
...
143 of the 277 programs here derive from the MeTTa examples of the project at
...
134 examples were written for this repository.
