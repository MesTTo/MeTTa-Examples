...
| `ch09-types` | declarations, `get-type`, sorted constructors, parametric, recursive, dependent and nondeterministic types |
...
| `ch17-concurrency-and-the-loop` | threads, mutexes, Linda, `hyperpose`, scopes, captured calls and class grains |
...
The merged corpus contains 330 examples that run in the shell suite.
...
143 of the 356 programs here derive from the MeTTa examples of the project at
...
213 examples were written for this repository.
