...
README's printed values, not MeTTa-specific replacements.

| Scallop feature | MeTTa seam used by the witness |
|---|---|
...
- Scallop's Python builder API is not reproduced name for name. MeTTa exposes
